...
import com.example.model.parking.strategy.ParkingStrategy;

/**
 * Service to enable the functioning of a parking lot.
...
public class ParkingLotService {
    ...
    /**
     * Allots a parking lot into the parking service.
     * Throws {@link ParkingLotException} if there is already a parking lot alloted to the service previously.
     * @param parkingLot
    ...
    /**
     * Parks a {@link Car} into the parking lot.
     * {@link ParkingStrategy} is used to decide the slot number and then the car is parked into the {@link PArkingLot} into that slot number.
    ...
    /**
     * Unparks a car from a slot.
     * Freed slot number is given back to the parking strategy so that it becomes available for further parkings.
     * 
    ...
    */
    ...
    /**
     * Helper method to validate whether the parking lot exists or not.
     * This is used to validate the existence of parking lot before doing any operation on it.
     */
