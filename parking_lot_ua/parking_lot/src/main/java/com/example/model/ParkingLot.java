...
import com.example.exceptions.SlotAlreadyOccupiedException;

/**
 * Model object to represent the functioing of a parking lot.
 */
public class ParkingLot {
    ...
    /**
     * Helper method to get a {@link Slot} object for a given slot number.
     * If slot does not exists, then new slot will be created before giving it back.
     * 
     * @param slotNumber Slot number.
     * @return Slot.
     */
    private Slot getSlot(final Integer slotNumber) {
        if (slotNumber < 0 || slotNumber > getCapacity()) {
    ...
    /**
     * Parks a given car into a given slot number.
     * 
     * 
     * @param car Car to be parked
     * @param slotNumber Slot number in which it has to be parked.
     * @return {@link Slot} if the parking succeeds. 
     * If the slot is already occupied then {@link SlotAlreadyOccupiedException} is thrown.
     */
