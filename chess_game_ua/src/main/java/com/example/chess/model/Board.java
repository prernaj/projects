...
import static com.example.chess.conditions.PieceCellOccupyBlockerFactory.kingCheckEvaluationBlockers;

/**
 * Model object for the board of a chess game.
 * A board has a size and a grid of cells.
 */
@Getter
public class Board {
    int boardSize;
